...
module.exports = {
	...
	// Project options.
	projectURL: 'tamd-wp/', // Local project URL of your already running WordPress site. Could be something like wpgulp.local or localhost:3000 depending upon your local WordPress setup.
	...
	// JS Vendor options.
	jsVendorSRC: './src/js/lib/*.js', // Path to JS vendor folder.
	...
	watchJsVendor: './src/js/lib/*.js', // Path to all vendor JS files.
